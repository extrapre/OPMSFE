...
import { getSearchResultsEmployeeRequestFilter, getGridDataAdvertisement1 } from "../../../../../ui-utils/commons";
import { getTextToLocalMapping, validateFields } from "../../utils";
import { showHideTableADV } from '../searchResource/citizenSearchFunctions'
...
export const searchApiCallForEmployeeFilter = async (state, dispatch) => {
  ...
  const isSearchBoxFirstRowValid = validateFields(
    ...
    "components.div.children.SearchFormForEmployee.children.cardContent.children.serviceRequestidContactNoAndRequestTypeContainer.children",
    state,
    dispatch,
  ...
  if (!(isSearchBoxFirstRowValid && isSearchBoxSecondRowValid)) {
    ...
    if (flag_for_api_call = true) {
      ...
      var data =
      {
        ...
        "applicationId": servicerequestid,
